/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=Server/wrangler.jsonc Server/worker-configuration.d.ts` (hash: 6f4072f396bed9f9d672ab9e0e7db6c8)
...
interface __BaseEnv_Env {
	...
	ASSETS: Fetcher;
	ADMIN_EVENTS: DurableObjectNamespace<import("./src/index").AdminEventHub>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AdminEventHub";
	}
